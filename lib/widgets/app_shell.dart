...
class _ScreenTransition extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return switch (index) {
      ...
      2 => ScaleTransition(
          scale: Tween<double>(begin: .988, end: 1).animate(animation),
          child: fade,
        ),
      3 => ScaleTransition(
          scale: Tween<double>(begin: .995, end: 1).animate(animation),
          child: fade,
        ),
      _ => SlideTransition(
          position: Tween<Offset>(begin: const Offset(0, .022), end: Offset.zero).animate(animation),
          child: fade,
        ),
    };
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          right: BorderSide(
            color: dark ? Colors.white.withValues(alpha: .06) : Colors.black.withValues(alpha: .06),
          ),
        ),
      ),
      child: Column(
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Academic OS • 2.3 Motion', style: TextStyle(fontSize: 10)),
                  ],
                ),
              ),
            ],
          ...
          for (var i = 0; i < AppShell.destinations.length; i++)
            Padding(
              ...
              child: _MotionNavItem(
                ...
                badge: i == 2 && state.pendingCount > 0 ? state.pendingCount : null,
          ...
          _SecondaryNav(
            ...
            label: 'Busca global',
            onTap: () => Navigator.push(context, motionRoute(const GlobalSearchScreen())),
          ),
          _SecondaryNav(
            icon: Icons.menu_book_rounded,
            label: 'Biblioteca',
            onTap: () => Navigator.push(context, motionRoute(const LibraryScreen())),
          ),
          const Spacer(),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      state.period.isEmpty ? state.course : '${state.course} • ${state.period}',
            ...
            child: Row(
              children: [
                AnimatedScale(
                  ...
                  child: Icon(widget.icon, size: 21, color: widget.selected ? primary : null),
                ),
                const SizedBox(width: 11),
                Expanded(
                  child: Text(widget.label, style: TextStyle(fontWeight: widget.selected ? FontWeight.w900 : FontWeight.w600)),
                ),
                if (widget.badge != null)
                  Container(
                    padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 3),
                    decoration: BoxDecoration(color: AppColors.gold, borderRadius: BorderRadius.circular(20)),
                    child: Text('${widget.badge}', style: const TextStyle(color: AppColors.petroleumDark, fontSize: 9, fontWeight: FontWeight.w900)),
                  ),
              ],
            ),
          ),
    ...
    return MouseRegion(
      ...
      child: AnimatedSlide(
        ...
        child: ListTile(
          ...
          title: Text(widget.label, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 13)),
          onTap: widget.onTap,
        ),
      ),
    );
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Row(
          children: [
            ...
            IconButton.filledTonal(
              tooltip: 'Biblioteca',
              onPressed: () => Navigator.push(context, motionRoute(const LibraryScreen())),
            ...
            IconButton.filledTonal(
              ...
              icon: AnimatedSwitcher(
                ...
                transitionBuilder: (child, animation) => RotationTransition(
                  turns: Tween<double>(begin: -.18, end: 0).animate(animation),
            ...
            IconButton.filledTonal(
              ...
              onPressed: () => Navigator.push(context, motionRoute(const SettingsScreen())),
